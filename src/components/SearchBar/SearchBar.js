        ...
        return (
            <div className="SearchBar">
                ...
                <div className="SearchBar-fields">
                    <input placeholder="Search Businesses" id="searchBar" onChange={this.handleTermChange} />
                    <input placeholder="Where?" id="searchBar" onChange={this.handleLocationChange} />
                </div>
